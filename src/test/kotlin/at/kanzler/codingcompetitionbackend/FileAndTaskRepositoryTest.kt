...
class FileAndTaskRepositoryTest(
    ...
    val file1 = at.kanzler.codingcompetitionbackend.model.File().apply {
        fileUrl = "/static/files/test1.txt"
        task = task1
    }

    val file2 = at.kanzler.codingcompetitionbackend.model.File().apply {
        fileUrl = "/static/files/test2.txt"
        task = task1
    }

    val file3 = at.kanzler.codingcompetitionbackend.model.File().apply {
        fileUrl = "/static/files/test3.txt"
        task = task1
    }

    val file4 = at.kanzler.codingcompetitionbackend.model.File().apply {
